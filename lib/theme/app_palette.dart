...
class AppThemes {
  ...
  static const AppThemeOption _default = AppThemeOption(
    ...
    palette: AppPalette(
      primary: Color.fromARGB(255, 230, 0, 0),
      primarydark: Color.fromARGB(255, 183, 0, 0),
      background: Color.fromARGB(255, 243, 241, 241),
      ...
      info: Color.fromARGB(255, 24, 143, 228),
      success: Color.fromARGB(255, 0, 161, 32),
  ...
  static const AppThemeOption _dark = AppThemeOption(
    ...
    isDark: true,
    palette: AppPalette(
      primary: Color.fromARGB(255, 210, 18, 18),
      primarydark: Color.fromARGB(255, 163, 12, 12),
