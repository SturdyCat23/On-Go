          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                const _StatusStep(title: 'Request Accepted', time: '1:00 PM', done: true, isFirst: true),
                const _StatusStep(title: 'Mechanic En Route', time: '1:05 PM', done: true),
                const _StatusStep(title: 'Mechanic Arrived', time: '1:10 PM', done: true),
                const _StatusStep(title: 'Work in Progress', time: 'Expected 12:15 PM', done: false),
